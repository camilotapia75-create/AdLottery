      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-white/60">{stats?.poolDrawn ? <span className="bg-green-500/20 text-green-300 px-3 py-1 rounded-full text-sm">✅ Already drawn</span> : <span className="bg-yellow-500/20 text-yellow-300 px-3 py-1 rounded-full text-sm">⏳ Pending draw</span>}</div>
          </div>
        </div>
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6">
          ...
          {drawResult && <div className={`mt-4 p-4 rounded-xl text-sm ${drawResult.startsWith("✅") ? "bg-green-500/20 text-green-300" : "bg-red-500/20 text-red-300"}`}>{drawResult}</div>}
        </div>
